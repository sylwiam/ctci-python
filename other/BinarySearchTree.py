...
class BinarySearchTree:
    ...
    def spliceOut(self):  # remove a successor from it's old location
        if self.isLeaf():
            if self.isLeftChild():
    ...
    def findSuccessor(self):  # find replacement for the node that is bein removed
        """ Find a node that can replace the current node, successor is the next higher node in the tree
